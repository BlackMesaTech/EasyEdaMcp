...
/** Check if a UUID string is valid (32 lowercase hex chars). */
...
/** Return the UUID if valid, otherwise generate a new one. */
...
/** Main packaging logic — builds the .eext zip archive. */
function main() {
	...
	const folderList: Array<string> = []; // unused but kept for compatibility
